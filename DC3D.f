C----- Check DC3D
      ...
      open(10,file='displacement.dat',status='replace')
      open(11,file='diff_x.dat',status='replace')
      open(12,file='diff_y.dat',status='replace')
      open(13,file='diff_z.dat',status='replace')
C-----do loop
      do i=1,10
            X=i !観測点
            Y=20.
     ...
     &        UX,UY,UZ,UXX,UYX,UZX,UXY,UYY,UZY,UXZ,UYZ,UZZ,IRET)
            ...
            WRITE(10,*) UX,UY,UZ!変位
            WRITE(11,*) UXX,UYX,UZX!x微分量
            WRITE(12,*) UXY,UYY,UZY!y微分量
            WRITE(13,*) UXZ,UYZ,UZZ!z微分量
      end do
C-----
      close(10)
      close(11)
